...
const CourseEnrolled = ({enrollment}) => {
  return (
    ...
    <div className='card border-0'>
        ...
        <img src={enrollment.course.course_small_image || `https://placehold.co/600x350?text=${enrollment.course.title}`} alt={enrollment.course.title} className='img-fluid' />
        </div>
        <div className='card-body'>
            ...
            {enrollment.course.levels &&   <div className="level">
                    <div className="d-flex align-items-center">
                        ...
                        <div className="text ps-2">{enrollment?.course?.levels?.name}</div>
                    </div>                                        
                </div> }
                ...
                <div className="rating ps-4">
                    <div className="d-flex align-items-center">
                        ...
                        <div className="text ps-2">{Number(enrollment.course.rating).toFixed(1)}</div>
                    </div>                                          
                </div>
            </div>
        </div>
